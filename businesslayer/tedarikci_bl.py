...
def tedarikci_ekle(iletisim_kisi,firma_telefon,firma_adres):
    tedarikci_dal.tedarikci_ekle(iletisim_kisi,firma_telefon,firma_adres)

def tedarikci_guncelle(tedarikci_id,iletisim_kisi,firma_telefon,firma_adres):
    if not tedarikci_id:
        raise ValueError('TedarikciID zorunludur')
    tedarikci_dal.tedarikci_guncelle(tedarikci_id,iletisim_kisi,firma_telefon,firma_adres)
